...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--model", type=Path, default=Path("results/model.joblib"))
...
def main() -> None:
    ...
    results = predict_emotion(wav_path, model, top_k=args.top_k)

    print(f"Predicting .wav: {args.wav}")
